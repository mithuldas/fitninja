...
<h4 class="pt-3 pt-md-1" align="center"> Post Purchase - Customer Data Form </h4><br>
...
<form action="/includes/process_customer_data_collector.php" method="post">
  ...
  <div class="row justify-content-center">
    <div class="form-group col-12 col-md-4">
      ...
      <div class="form-check ">
        ...
        <br>
        <input class="form-check-input" type="radio" name="11" id="active" value="Active" required
        <?php
        ...
        <br>
        <input class="form-check-input" type="radio" name="11" id="veryactive" value="Very Active" required
        <?php
    ...
    <div class="form-group col-12 col-md-4">
      ...
      <div class="form-check ">
        <input class="form-check-input" type="radio" name="12" id="weightLoss" value="Weight Loss" required
        <?php
        ...
        <br>
        <input class="form-check-input" type="radio" name="12" id="muscle" value="Muscle Gain" required
        <?php
        ...
        <br>
        <input class="form-check-input" type="radio" name="12" id="flexibility" value="Flexibility" required
        <?php
  ...
  <div class="row">
    ...
    <div class="form-group col-12 col-md-4">
      <label class="pt-2" for="genComments">19. General comments and notes </label><br>
      <textarea class="form-control" id="genComments" rows="2" name="19" style="resize: none" placeholder="" ><?php
        if ($mode=="Update"){
