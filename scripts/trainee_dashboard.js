    ...
    if(unassignedProducts.length>0){ // if there are products that haven't been scheduled yet, display them next
      ...
      " <div class='table100'>\
        ...
        unassignedProducts.forEach(function (product, index) {
          ...
          tableBody=tableBody+'<tr class=\'row100 body\'><td class="cell100 column1 unassigned">'+product.productName+'</td><td class="cell100 column2 unassigned">'+momentDateString+'</td><td class="cell100 column3 unassigned">'+'We\'re working your schedule.'+'</td></tr>';
